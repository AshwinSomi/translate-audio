...
export default function HomePage(props) {
  ...
  return (
    <main
     ...
     pb-20 "
    >
      <h1 className="front-semibold text-5xl sm:text-6xl md:text-7xl ">
        {" "}
      ...
      <button
        ...
        className="flex items-center specialButton px-4 py-2 rounded-lg text-base justify-between gap-4 mx-auto max-w-full my-4 "
      >
        <p className="text-blue-400 ">
          {recodingStatus === "inactive" ? "Record" : "Stop recording"}
        </p>
        ...
        <i
          className={
            ...
            (recodingStatus === "recording" ? "text-rose-300" : "")
          }
        ></i>
      </button>
